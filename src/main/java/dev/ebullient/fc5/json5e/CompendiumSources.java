...
public class CompendiumSources {
    ...
    static {
        ...
        abvToName.put("UA2020SubclassesPt1", UA_PREFIX + "2020 Subclasses, Part 1");
        abvToName.put("UA2020SC2", UA_PREFIX + "2020 Subclasses, Part 2");
        abvToName.put("UA2020SubclassesPt2", UA_PREFIX + "2020 Subclasses, Part 2");
        abvToName.put("UA2020SC3", UA_PREFIX + "2020 Subclasses, Part 3");
        abvToName.put("UA2020SubclassesPt3", UA_PREFIX + "2020 Subclasses, Part 3");
        abvToName.put("UA2020SC4", UA_PREFIX + "2020 Subclasses, Part 4");
        abvToName.put("UA2020SubclassesPt4", UA_PREFIX + "2020 Subclasses, Part 4");
        abvToName.put("UA2020SC5", UA_PREFIX + "2020 Subclasses, Part 5");
        abvToName.put("UA2020SubclassesPt5", UA_PREFIX + "2020 Subclasses, Part 5");
        abvToName.put("UA2020SCR", UA_PREFIX + "2020 Subclasses Revisited");
        abvToName.put("UA2020SubclassesRevisited", UA_PREFIX + "2020 Subclasses Revisited");
        ...
        abvToName.put("UA2021FolkOfTheFeywild", UA_PREFIX + "2021 Folk of the Feywild");
        abvToName.put("UA2021GL", UA_PREFIX + "2021 Gothic Lineages");
        abvToName.put("UA2021GothicLineages", UA_PREFIX + "2021 Gothic Lineages");
        abvToName.put("UA2021MoS", UA_PREFIX + "2021 Mages of Strixhaven");
        abvToName.put("UA2021MagesOfStrixhaven", UA_PREFIX + "2021 Mages of Strixhaven");
        abvToName.put("UA2021TotM", UA_PREFIX + "2021 Travelers of the Multiverse");
        abvToName.put("UA2021TravelersOfTheMultiverse", UA_PREFIX + "2021 Travelers of the Multiverse");
        ...
        abvToName.put("UAThreePillarExperience", UA_PREFIX + "Three-Pillar Experience");
        abvToName.put("UAA", UA_PREFIX + "Artificer");
        abvToName.put("UAArtificer", UA_PREFIX + "Artificer");
        ...
        abvToName.put("UAATrioOfSubclasses", UA_PREFIX + "A Trio of Subclasses");
        abvToName.put("UABAM", UA_PREFIX + "Barbarian and Monk");
        abvToName.put("UABarbarianAndMonk", UA_PREFIX + "Barbarian and Monk");
        abvToName.put("UABAP", UA_PREFIX + "Bard and Paladin");
        abvToName.put("UABardAndPaladin", UA_PREFIX + "Bard and Paladin");
        abvToName.put("UABBC", UA_PREFIX + "Bard: Bard Colleges");
        abvToName.put("UABardBardColleges", UA_PREFIX + "Bard: Bard Colleges");
        abvToName.put("UABPP", UA_PREFIX + "Barbarian Primal Paths");
        abvToName.put("UABarbarianPrimalPaths", UA_PREFIX + "Barbarian Primal Paths");
        abvToName.put("UACAM", UA_PREFIX + "Centaurs and Minotaurs");
        abvToName.put("UACentaursMinotaurs", UA_PREFIX + "Centaurs and Minotaurs");
        abvToName.put("UACDD", UA_PREFIX + "Cleric: Divine Domains");
        abvToName.put("UAClericDivineDomains", UA_PREFIX + "Cleric: Divine Domains");
        abvToName.put("UACDW", UA_PREFIX + "Cleric, Druid, and Wizard");
        abvToName.put("UAClericDruidWizard", UA_PREFIX + "Cleric, Druid, and Wizard");
        ...
        abvToName.put("UADruid", UA_PREFIX + "Druid");
        ...
        abvToName.put("UAElfSubraces", UA_PREFIX + "Elf Subraces");
        abvToName.put("UAF", UA_PREFIX + "Fighter");
        abvToName.put("UAFighter", UA_PREFIX + "Fighter");
        ...
        abvToName.put("UAFiendishOptions", UA_PREFIX + "Fiendish Options");
        abvToName.put("UAFRR", UA_PREFIX + "Fighter, Ranger, and Rogue");
        abvToName.put("UAFighterRangerRogue", UA_PREFIX + "Fighter, Ranger, and Rogue");
        ...
        abvToName.put("UAGothicHeroes", UA_PREFIX + "Gothic Heroes");
        abvToName.put("UAGHI", UA_PREFIX + "Greyhawk Initiative");
        abvToName.put("UAGreyhawkInitiative", UA_PREFIX + "Greyhawk Initiative");
        abvToName.put("UAGSS", UA_PREFIX + "Giant Soul Sorcerer");
        abvToName.put("UAGiantSoulSorcerer", UA_PREFIX + "Giant Soul Sorcerer");
        abvToName.put("UAKOO", UA_PREFIX + "Kits of Old");
        abvToName.put("UAKitsOfOld", UA_PREFIX + "Kits of Old");
        ...
        abvToName.put("UAMonk", UA_PREFIX + "Monk");
        abvToName.put("UAMAC", UA_PREFIX + "Mass Combat");
        abvToName.put("UAMassCombat", UA_PREFIX + "Mass Combat");
        abvToName.put("UAMC", UA_PREFIX + "Modifying Classes");
        abvToName.put("UAModifyingClasses", UA_PREFIX + "Modifying Classes");
        ...
        abvToName.put("UAPrestigeClassesRunMagic", UA_PREFIX + "Prestige Classes and Rune Magic");
        abvToName.put("UAR", UA_PREFIX + "Ranger");
        abvToName.put("UARanger", UA_PREFIX + "Ranger");
        abvToName.put("UARAR", UA_PREFIX + "Ranger and Rogue");
        abvToName.put("UARangerAndRogue", UA_PREFIX + "Ranger and Rogue");
        abvToName.put("UARCO", UA_PREFIX + "Revised Class Options");
        abvToName.put("UARevisedClassOptions", UA_PREFIX + "Revised Class Options");
        abvToName.put("UARoE", UA_PREFIX + "Races of Eberron");
        abvToName.put("UARacesOfEberron", UA_PREFIX + "Races of Eberron");
        abvToName.put("UARoR", UA_PREFIX + "Races of Ravnica");
        abvToName.put("UARacesOfRavnica", UA_PREFIX + "Races of Ravnica");
        abvToName.put("UARSC", UA_PREFIX + "Revised Subclasses");
        abvToName.put("UARevisedSubclasses", UA_PREFIX + "Revised Subclasses");
        abvToName.put("UAS", UA_PREFIX + "Sorcerer");
        abvToName.put("UASorcerer", UA_PREFIX + "Sorcerer");
        ...
        abvToName.put("UASidekicks", UA_PREFIX + "Sidekicks");
        ...
        abvToName.put("UATheFaithful", UA_PREFIX + "The Faithful");
        abvToName.put("UATMC", UA_PREFIX + "The Mystic Class");
        abvToName.put("UATheMysticClass", UA_PREFIX + "The Mystic Class");
        ...
        abvToName.put("UATheRangerRevised", UA_PREFIX + "The Ranger, Revised");
        abvToName.put("UATSC", UA_PREFIX + "Three Subclasses");
        abvToName.put("UAThreeSubclasses", UA_PREFIX + "Three Subclasses");
        abvToName.put("UAVR", UA_PREFIX + "Variant Rules");
        abvToName.put("UAVariantRules", UA_PREFIX + "Variant Rules");
        abvToName.put("UAWA", UA_PREFIX + "Waterborne Adventures");
        abvToName.put("UAWaterborneAdventures", UA_PREFIX + "Waterborne Adventures");
        abvToName.put("UAWAW", UA_PREFIX + "Warlock and Wizard");
        abvToName.put("UAWarlockAndWizard", UA_PREFIX + "Warlock and Wizard");
        abvToName.put("UAWGE", "Wayfinder's Guide to Eberron");
        abvToName.put("UAWayfindersGuideToEberron", "Wayfinder's Guide to Eberron");
        abvToName.put("UAWR", UA_PREFIX + "Wizard Revisited");
        abvToName.put("UAWizardRevisited", UA_PREFIX + "Wizard Revisited");
